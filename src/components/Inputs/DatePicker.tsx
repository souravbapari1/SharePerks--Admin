...
const DatePickerOne = (props: InputProps) => {
  useEffect(() => {
    // Init flatpickr
      ...
      <div className="relative">
        <input
          className={` form-datepicker 
                    w-full rounded-lg border-[1.5px] dark:border-form-strokedark  border-stroke  bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default
                    ${
                      props.disabled
