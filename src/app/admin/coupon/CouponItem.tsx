...
function CouponItem({ data, reload }: { data: CouponData; reload: Function }) {
    ...
    >
      <div className="flex items-center gap-3 p-2.5 xl:p-5">
        <div className="flex-shrink-0">
          <Image
            src={`${client.baseUrl}/${data.couponImage}`}
            alt="Brand"
            width={48}
            height={48}
      ...
      <div className=" items-center text-xl gap-6 justify-center p-2.5 flex xl:p-5">
        <Link href={"/admin/coupon/" + data._id}>
          <AiOutlineEdit />
        </Link>
